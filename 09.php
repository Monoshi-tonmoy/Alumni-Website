...
<body>
    ...
    <table>
        ...
        $sql="SELECT avatar,username,email,phone,recentAddress,district,roll,working_place,position FROM demoalumni natural join work WHERE series=09 ORDER BY roll";
